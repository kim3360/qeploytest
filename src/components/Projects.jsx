...
// ✏️ Replace these entries with your own work. `liveUrl` / `githubUrl` are
//    placeholders — drop in real links whenever you're ready.
const projects = [
  {
    id: 1,
              ...
              <div className="project-image">
                ...
                <div className="project-overlay">
                  <div className="overlay-links">
                    <a href={project.liveUrl} className="overlay-link" aria-label={`View ${project.title} live`}>
                      <ExternalIcon />
                    </a>
                    <a href={project.githubUrl} className="overlay-link" aria-label={`View ${project.title} source code`}>
                      <GitHubIcon />
                    </a>
                  </div>
                </div>
